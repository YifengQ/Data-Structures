...
{
	std::ofstream log1;///opens the log1 to record the cities it goes too.
	log1.open("log.txt", std::ofstream::out | std::ofstream::app);
...
/**
 * @breif gets the next available city
 * @param t_city 
 * @return the city
